...
from users.forms import UserRegistrateForm, UserPasswordResetForm, UserProfileForm, MakeAnAppointmentForm
...
class MakeAnAppointmentView(CreateView):
    model = MakeAnAppointment
    form_class = MakeAnAppointmentForm
    template_name = 'users/make_an_appointment.html'
    success_url = reverse_lazy('users:make_an_appointment')
